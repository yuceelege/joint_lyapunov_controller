...
If you use this code, please cite the inspiration paper:

```bibtex
@article{joint_lyapunov_control,
  title={Joint Training of Control Policies and Lyapunov Certificates},
  author={[Authors from arXiv:2404.07956]},
